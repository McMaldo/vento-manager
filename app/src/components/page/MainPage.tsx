      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-xs font-bold ${
                            daysLeft(delivery.dueDate) <= 5
                              ? "text-red-500"
                              : daysLeft(delivery.dueDate) <= 10
                                ? "text-amber-500"
                                : "text-emerald-500"
                          }`}
                        >
                          {daysLeft(delivery.dueDate)}d restantes
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div
              className={`bg-linear-to-br ${getProgressColor("activo")} rounded-xl p-5`}
            >
              <p className="text-sm font-medium font-icon mb-1">Proyectos</p>
              <p className="text-3xl font-bold">{projects.length}</p>
            </div>
            <div
              className={`bg-linear-to-br ${getProgressColor("completado")} rounded-xl p-5`}
            >
