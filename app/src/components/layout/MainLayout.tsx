...
export default function MainLayout() {
  return (
    <>
      <div className="h-dvh grid [grid-template-areas:'header''main''aside'] grid-rows-[auto_1fr_auto] md:[grid-template-areas:'header_header''main_aside'] md:grid-cols-[minmax(0,1fr)_auto] md:grid-rows-[3rem_calc(100dvh-3rem)]">
        <Header />
